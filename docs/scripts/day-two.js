...
function validationDataSlides() {
  return [
    "09-validation-body/01-transition.md",
    "09-validation-body/02-introduction.md",
    "09-validation-body/03-class-validator.md",
    "09-validation-body/100-validation-exercice-body.md",
  ];
}
